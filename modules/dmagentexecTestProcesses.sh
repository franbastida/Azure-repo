...
### Usage: dmagentexecTestProcesses ()
### Example: dmagentexecTestProcesses rcNormal rcError "SEVERITY[warning]"
### Example - override list of docbases: dmagentexecTestProcesses rcNormal rcError "SEVERITY[warning]" "DOCBASES[develop Engineering]"


dmagentexecTestProcesses () {
