...
_OBJECT="JMS"
outputHandler "## Running RUNNER: test_cs_jms_d2.sh - MODULE: jmsCountProcess ##" "INFO" "$_APPLICATION" "$_OBJECT"
jmsCountProcess rcNormalProc rcErrorProc "SEVERITY[$_SEVERITY]"
...
### LOCAL
    ...
    _OBJECT="JMS"
    outputHandler "## Running RUNNER: test_cs_jms_d2.sh - MODULE: jmsTestConnection ##" "INFO" "$_APPLICATION" "$_OBJECT"
    ...
    _OBJECT="docbase"
    outputHandler "## Running RUNNER: test_cs_jms_d2.sh - MODULE: docbaseTestConnection ##" "INFO" "$_APPLICATION" "$_OBJECT"
    ...
    _OBJECT="JMS"
    outputHandler "## Running RUNNER: test_cs_jms_d2.sh - MODULE: jmsTestD2Method ##" "INFO" "$_APPLICATION" "$_OBJECT"
